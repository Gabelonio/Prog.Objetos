...
public class EditarHistorialMedico extends JFrame implements ActionListener{
	...
	EditarHistorialMedico(String nombre,String apellidos,ArrayList<HistorialMedico> coleccion)
	{
		...
		*/
		...
		//Configurando los letreros
		botonAgregar=new JButton("Editar Paciente"); 
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Editar Paciente"))
		{
			...
			{
				if(Double.parseDouble(FechaNacimientoDia.getText())<=31&&Double.parseDouble(FechaNacimientoMes.getText())<=12&&Double.parseDouble(FechaNacimientoAnio.getText())>=1950&&Double.parseDouble(FechaExpedicionDia.getText())<=31&&Double.parseDouble(FechaExpedicionMes.getText())<=12&&Double.parseDouble(FechaExpedicionAnio.getText())>=1950)
				{
					...
					Tabla.set(ubicacion,new HistorialMedico(Nombre.getText(),Apellidos.getText(),genero,(FechaNacimientoDia.getText()+"/"+FechaNacimientoMes.getText()+"/"+FechaNacimientoAnio.getText()),NombreHospital.getText(),UbicacionHospital.getText(),Direccion.getText(),(FechaExpedicionDia.getText()+"/"+FechaExpedicionMes.getText()+"/"+FechaExpedicionAnio.getText()),Descripcion.getText()));
